    ...
    return(
        <Box>
            <Grid2 container className="text-beige" sx={{width:"100vw", justifyContent: "center"}}>
                ...
                <motion.h1 initial="initial" whileInView="whileInView" variants={fadeRight} transition={{delay:0.6, duration:1}} className={`${satoshiLight.className} p-0 relative mt-[50px] text-[50px] sm:text-[100px]`}>Arik <span className={`${gambettaLightItalic.className}`}>Andersson</span></motion.h1>
                    <motion.div initial="initial" whileInView="whileInView" variants={fadeIn}><Image
                    src="/Andersson.png"
                    width={880}
                    height={769}
                    alt="Andersson"
                ...
                <Grid2 container sx={{justifyContent: "center", marginX:"10px", textAlign:"center"}}>
                    <Grid2 sx={{width:"568px"}}>
                        <motion.h2 initial="initial" whileInView="whileInView" variants={small ? fadeLeft : fadeRight} transition={{duration:1}} className={`${satoshiLight.className} p-0 text-[48px] leading-[52.8px]`}>A website that leaves <span className={`${gambettaLightItalic.className}`}>a lasting impression!</span></motion.h2>
                    </Grid2>
                    <Grid2 container sx={{width:"568px"}}>
                        ...
                        <Grid2 container sx={{justifyContent:"center", width:"100%"}}>
                            <motion.div initial="initial" whileInView="whileInView" variants={fadeRight} transition={small ? {duration:1, delay: 0.5 } : {duration:1}} className="m-0 p-0"><FiTwitter className={`${styles.icon} hover:animate-bounce`} /></motion.div>
                            <motion.div initial="initial" whileInView="whileInView" variants={fadeRight} transition={small ? {duration:1, delay:1} : {duration:1, delay: 0.5}} className="m-0 p-0"><FaInstagram className={`${styles.icon} hover:animate-bounce`} /></motion.div>
                            <motion.div initial="initial" whileInView="whileInView" variants={fadeRight} transition={small ? {duration:1, delay:1.5} : {duration:1, delay: 1}} className="m-0 p-0"><FaDribbble className={`${styles.icon} hover:animate-bounce`} /></motion.div>
                            <motion.div initial="initial" whileInView="whileInView" variants={fadeRight} transition={small ? {duration:1, delay:2} : {duration:1, delay: 1.5}} className="m-0 p-0"><FaBehance className={`${styles.icon} hover:animate-bounce`} /></motion.div>
                        </Grid2>
                    </Grid2>
