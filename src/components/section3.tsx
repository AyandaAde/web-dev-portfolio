    ...
    return (
        <Box sx={{ width: { xs: "300px", md: "100%" }, display: "flex", flexDirection: "column", alignItems: "center", margin: "150px 0 0 0" }}>
            <Box sx={{ width: { xs: "300px", md: "710px" } }} className={`${satoshi.className} text-beige text-center`}>
                <p className={`text-[13px] leading-[160%] tracking-[1.5px]`}>THE PROCESS</p>
                <h1 className={`${satoshiLight.className} leading=[100%] text-[70px] sm:text-[128px] font-light`}>Your Website <span className={`${gambettaLightItalic.className} font-light`}>in 5 Steps</span></h1>
                <p className={`${chillax.className} muted-text text-[20px] leading-[170%]`}>Our process ensures that we create a website tailored to your business needs.</p>
            </Box>
