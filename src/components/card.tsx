  ...
  return (
    <Card sx={{width:{xs:"270px", sm:"300px", lg: "520px"}, position: "relative" }}>
      <CardMedia
        ...
        image={props.image}
      />
      <motion.div initial={{opacity:0, }} whileInView={{opacity:1}} transition={{duration:1}}><CardActions className='backdrop' sx={{width: "95%", position: "absolute", left: "2.5%", height: "55px", bottom: "12px", display: "flex", justifyContent: "space-between", alignItems: "center", padding: "12px 16px", gap: "32px", background: "rgba(255, 255, 255, 0.05)", border: "1px solid rgba(255, 255, 255, 0.15)", borderRadius: "2px" }}>
